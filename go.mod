...
require (
	...
	open-cluster-management.io/ocm v0.15.1-0.20241125065026-7a190f1a2b18
...
require (
	...
	github.com/cloudevents/sdk-go/protocol/kafka_confluent/v2 v2.0.0-20250325190102-6de37de32b83 // indirect
